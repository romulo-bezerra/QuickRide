...
//Função calcula a hora estimada de chegada ao destino da carona
//somando-se a hora da saída e a duração dada pela API do tráfego
function calculaHoraChegadaAoDestino(dataViajem, horaSaida, duracaoDaViajem){
	...
	if(duracaoDaViajem.match(/dia/)){
		...
		duracao = Number(diaEmHora) + Number(hora);
	}
	...
	//Atribue ao objeto dataHoraChegada a soma do objeto dataHoraSaida com a hora da duracao
	dataHoraSaida.setHours(dataHoraSaida.getHours() + duracao);
	
	//Atribue ao objeto dataHoraChegada a soma do objeto dataHoraSaida com a os minutos da duracao
